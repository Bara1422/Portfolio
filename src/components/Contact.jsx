  ...
  return (
    <div className='mt-20 flex-col' id='contact'>
      ...
      <div className='flex flex-col md:flex-row md:justify-evenly lg:justify-center lg:gap-10 gap-4  pt-4'>
        <div className='flex flex-col text-center border border-gray-300 p-4 gap-2 rounded-3xl w-72 md:mx-0 mx-auto shadow-md shadow-eden-400'>
        ...
        <div className='flex flex-col text-center mx-auto border p-4 border-gray-300  gap-2 rounded-3xl md:mx-0 w-72 shadow-md shadow-eden-500 dark:shadow-eden-400'>
